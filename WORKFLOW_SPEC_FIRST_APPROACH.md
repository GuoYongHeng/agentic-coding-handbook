...
Copilot 或 Cursor 等 AI 编程智能体完全依赖于你提供的输入。如果上下文模糊或分散，AI 将产生不准确、不一致或过于通用的代码。这正是规格优先方法的优势所在：这是一种让你为 AI 提供高质量、聚焦工作范围的实践，从而以更少的修正获得更好的输出。
...
**创建 plan.md 和 todo.md 文件：** 创建 plan.md 和 todo.md 确保 AI 编程智能体从清晰、结构化的项目理解出发。plan.md 记录完整的实现蓝图，而 todo.md 将其分解为小型可提示的任务，从而实现更安全、更准确的代码生成，更好的验证检查点，以及更快、更可靠的开发周期。
